...
export const CSLB_LICENSE_DISPLAY = `${CSLB_LICENSE_CLASS} License #${CSLB_LICENSE_NUMBER}`;
...
export const EMR_DISPLAY = String(EMR_VALUE);
export const EMR_INDUSTRY_AVERAGE = 1.0 as const;
export const EMR_INDUSTRY_AVERAGE_DISPLAY = String(EMR_INDUSTRY_AVERAGE);
/** For StatsSection count-up animation: animateTo uses integer, formatted as (n/100).toFixed(2) */
export const EMR_ANIMATE_INTEGER = Math.round(EMR_VALUE * 100);
